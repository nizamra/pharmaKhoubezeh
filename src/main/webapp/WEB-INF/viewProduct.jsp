				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="index.html">Home</a> <span class="mx-2 mb-0">/</span> <a
							...
							class="text-black">${productShow.name}</strong>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row">
					<div class="col-md-5 mr-auto">
						<div class="border text-center">
							<img src="${productShow.photosImagePath}" alt="Image"
								class="img-fluid p-5">
						</div>
					</div>
					<div class="col-md-6">
						...
						<p>
							<strong class="text-primary h4">${productShow.price}
								Shekels</strong>
						</p>
						<p>
							<strong class="text-primary h4">${productShow.symptom}</strong>
						</p>
						...
						<p>
							<a href="/addToCart/${productShow.id}"
