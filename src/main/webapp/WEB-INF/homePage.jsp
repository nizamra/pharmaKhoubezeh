      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-6 col-lg-4 text-center item mb-4">
            ...
            <a href="shop-single.html"> <img class="vw"  src="imgs/product_01.png" alt="Image"></a>
            <h3 class="text-dark"><a href="shop-single.html">Bioderma</a></h3>
            <p class="price"><del>95.00</del> &mdash; $55.00</p>
          </div>
          <div class="col-sm-6 col-lg-4 text-center item mb-4">
            <a href="shop-single.html"> <img class="vw"  src="imgs/hairgil.jpg" alt="Image"></a>
            <h3 class="text-dark"><a href="shop-single.html">Hair Gil</a></h3>
          ...
          <div class="col-sm-6 col-lg-4 text-center item mb-4">
            ...
            <a href="shop-single.html"> <img class="vw"  src="imgs/handcream.jpg" alt="Image"></a>
            <h3 class="text-dark"><a href="shop-single.html"> Hand Cream</a></h3>
            <p class="price"><del>45.00</del> &mdash; $20.00</p>
          </div>
          <div class="col-sm-6 col-lg-4 text-center item mb-4">
            <a href="shop-single.html"> <img class="vw"  src="imgs/paramol.jpg" alt="Image"></a>
            <h3 class="text-dark"><a href="shop-single.html">Paramol</a></h3>
            <p class="price">$38.00</p>
          </div>
          <div class="col-sm-6 col-lg-4 text-center item mb-4">
            <span class="tag">Sale</span>
            <a href="shop-single.html"> <img class="vw" src="imgs/paraflu.jpg" alt="Image"></a>
