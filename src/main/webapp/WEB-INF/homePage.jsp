		...
		<div class="site-navbar py-2">
			...
			<div class="container">
				<div class="d-flex align-items-center justify-content-between">
					<div class="logo">
						<div class="site-logo">
							<a href="/" class="js-logo-clone"><img
					...
					<div class="main-nav d-none d-lg-block">
						...
						<ul class="site-menu js-clone-nav d-none d-lg-block">
							...
							<c:choose>
								<c:when test="${ currentUser.getUserRole().get(0).getId() == 2}">
					...
					<div class="icons">
						<a href="#" class="icons-btn d-inline-block js-search-open"><span
							class="icon-search"></span></a> <a href="/cart"
				...
				<div class="row">
					<div class="col-lg-7 mx-auto order-lg-2 align-self-center">
						<div class="site-block-cover-content text-center">
							...
							<c:choose>
								<c:when
									test="${ currentUser.getUserRole().get(currentUser.getUserRole().size() - 1).getId() == 3}">
									<p>
										<a href="/pharmacy" class="btn btn-primary px-5 py-3">Add
											Product</a>
									</p>
								</c:when>
								<c:otherwise>
									<p>
										<a href="#pharm" class="btn btn-primary px-5 py-3">Shop
											Now</a>
									</p>
								</c:otherwise>
							</c:choose>
					...
					<div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
						<div class="banner-wrap bg-warning h-100">
							<a href="#" class="h-100">
								...
								<p>
									When you buy products above 50$ <strong>You get a gift
										card of 10$ </strong>
								</p>
							</a>
						</div>
