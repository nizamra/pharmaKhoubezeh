				...
				<div class="row align-items-stretch section-overlap">
					<div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
						<div class="banner-wrap bg-primary h-100">
							<a href="#" class="h-100">
								<h5>
									We <br> Deliver anywhere
								</h5>
								<p>
									deliver to all places <strong>You can buy any medicine
										you want and we will deliver it to you</strong>
								</p>
							</a>
						</div>
					</div>
					<div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
						<div class="banner-wrap h-100">
							<a href="#" class="h-100">
								...
								<p>
									Sales on all the products <strong>In the end of the
										season.</strong>
								</p>
							</a>
						</div>
					...
					<div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
						<div class="banner-wrap bg-warning h-100">
							<a href="#" class="h-100">
								...
								<p>
									When you buy products above 50$ <strong>You git a gift
										card of 10$ </strong>
								</p>
							</a>
						</div>
				...
				<div class="row">
					<c:forEach items="${ products }" var="product">
						<div class="col-sm-6 col-lg-4 text-center item mb-4">
							<a href="/specificproduct/${product.id}"> <img class="vw"
								src="${ product.photosImagePath }" alt="Image"></a>
							<h3 class="text-dark">
								<a href="/specificproduct/${product.id}">${ product.name }</a>
							</h3>
					...
					<div class="col-md-12 block-3 products-wrap">
						<div class="nonloop-block-3 owl-carousel">
							...
							<div class="text-center item mb-4">
								<a href="shop-single.html"> <img src="imgs/product_03.png"
									alt="Image"></a>
								<h3 class="text-dark">
							...
							<div class="text-center item mb-4">
								<a href="shop-single.html"> <img src="imgs/product_01.png"
									alt="Image"></a>
								<h3 class="text-dark">
									<a href="shop-single.html">Umcka Cold Care</a>
								</h3>
							...
							<div class="text-center item mb-4">
								<a href="shop-single.html"> <img src="imgs/product_02.png"
									alt="Image"></a>
								<h3 class="text-dark">
									<a href="shop-single.html">Umcka Cold Care</a>
								</h3>
							...
							<div class="text-center item mb-4">
								<a href="shop-single.html"> <img src="imgs/product_04.png"
									alt="Image"></a>
								<h3 class="text-dark">
									<a href="shop-single.html">Umcka Cold Care</a>
								</h3>
				...
				<div class="row">
					<div class="col-md-12 block-3 products-wrap">
						<div class="nonloop-block-3 no-direction owl-carousel">
							...
							<div class="testimony">
								<blockquote>
									<img src="imgs/person_1.jpg" alt="Image"
